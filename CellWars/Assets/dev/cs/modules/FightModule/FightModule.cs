...
public class FightModule : BaseModule {
    ...
    void Start()
    {
        ...
        if (hideHeight > 0)
        {
            ...
            animTrans.anchoredPosition = new Vector2(0, hideHeight * PosMgr.CELL_H);
    ...
    public bool CheckRoll()
    {
        ...
        if (rollCount > 0)
        {
			...
			LeanTween.move(animTrans, new Vector2(0, rollCount * PosMgr.CELL_H), tweenTime).onComplete = StepRollComplete;
