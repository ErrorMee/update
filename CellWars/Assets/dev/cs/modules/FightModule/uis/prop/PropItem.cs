...
public class PropItem : MonoBehaviour
{
    ...
    public int icon
    {
        set
        {
            ...
            {
                iconImage.overrideSprite = GameMgr.resourceMgr.GetSprite("icon/prop.ab", "prop_" + _icon);
                selectImage.overrideSprite = GameMgr.resourceMgr.GetSprite("icon/prop.ab", "prop_" + _icon);
            }
        }
        get { return _icon; }
    }
