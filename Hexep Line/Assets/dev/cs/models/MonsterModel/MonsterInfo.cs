...
public class MonsterInfo:IComparable
{
	...
	public void SetConfig(int id)
	{
        ...
        special0 = 0;
        special1 = 0;
		config = (config_monster_item)ResModel.Instance.config_monster.GetItem(id);
        if (config != null)
        {
    ...
    public void RecursionRandomCrawl()
    {
        if (crawlCount > 0)
        {
            ...
            List<CellDirType> priorityDirList = PosUtil.PriorityDirList((int)randomCrawlDir,true);
