...
public class EnergyModule : BaseModule
{
	...
	private void InitWealthView(int type = 0)
	{
		...
		config_wealth_item config = (config_wealth_item)ResModel.Instance.config_wealth.GetItem ((int)WealthTypeEnum.Energy);
	...
	{
		ModuleModel.Instance.RemoveUIModule((int)ModuleEnum.ENERGY);
