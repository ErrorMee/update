...
public class MapItem : MonoBehaviour {
    ...
    public void SetView(bool enable, int starNum, int oldStar = -1)
	{
        ...
        if (enable)
        {
            ...
            {
				nameText.color = ColorUtil.GetColor(ColorUtil.MAP_PASS);
            }
            else
            {
                nameText.color = ColorUtil.GetColor(ColorUtil.MAP_OPEN);
				anim.Play();
            }
        ...
        else
        {
            ...
            nameText.color = ColorUtil.GetColor(ColorUtil.MAP_CLOSE,0.5f);
