...
public class PrepareRecord : MonoBehaviour {
	...
	void Start()
	{
		...
		if (BattleModel.Instance.crtConfig != null && BattleModel.Instance.crtConfig.special != null && BattleModel.Instance.crtConfig.special != "")
		{
			...
			//iconImage.overrideSprite = ResModel.Instance.GetSprite("icon/" + BattleModel.Instance.crtConfig.special.Split(new char[] { '_' })[0] + "/" +  BattleModel.Instance.crtConfig.special);
		}
	}
